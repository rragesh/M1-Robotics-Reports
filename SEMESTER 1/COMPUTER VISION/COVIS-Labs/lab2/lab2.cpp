...
//        line( firstFrame, firstCorners[0] , firstCorners[1] , Scalar(0, 255, 0), 2 );
//        line( firstFrame, firstCorners[1] , firstCorners[2] , Scalar( 0, 255, 0), 2 );
//        line( firstFrame, firstCorners[2] , firstCorners[3] , Scalar( 0, 255, 0), 2 );
//        line( firstFrame, firstCorners[3] , firstCorners[0] , Scalar( 0, 255, 0), 2 );

...
!
data_element create variable  &
   variable_name = .SCARA_IRCCyN.q1d  &
   adams_id = 6  &
   initial_condition = 0.0  &
   function = ""
!
...
!
data_element create variable  &
   variable_name = .SCARA_IRCCyN.q2d  &
   adams_id = 7  &
   initial_condition = 0.0  &
   function = ""
!
...
!
data_element create plant output  &
   plant_output_name = .SCARA_IRCCyN.q_out  &
   adams_id = 4  &
   variable_name =  &
      .SCARA_IRCCyN.q1,  &
      .SCARA_IRCCyN.q2
...
!
ude create instance  &
   instance_name = .SCARA_IRCCyN.Controls_Plant_3  &
   definition_name = .controls.controls_plant  &
   location = 0.0, 0.0, 0.0  &
   orientation = 0.0, 0.0, 0.0
!
ude create instance  &
   instance_name = .SCARA_IRCCyN.velocity_control  &
   definition_name = .controls.controls_plant  &
   location = 0.0, 0.0, 0.0  &
   orientation = 0.0, 0.0, 0.0
!
...
variable modify  &
   ...
   string_value = "pc-d05-07.eleves.ecn"
!
variable modify  &
...
!
variable modify  &
   variable_name = .SCARA_IRCCyN.Controls_Plant_3.input_channels  &
   object_value =   &
      .SCARA_IRCCyN.q1d,  &
      .SCARA_IRCCyN.q2d
!
variable modify  &
   variable_name = .SCARA_IRCCyN.Controls_Plant_3.output_channels  &
   object_value =   &
      .SCARA_IRCCyN.q1,  &
      .SCARA_IRCCyN.q2,  &
      .SCARA_IRCCyN.x,  &
...
!
variable modify  &
   variable_name = .SCARA_IRCCyN.Controls_Plant_3.file_name  &
   string_value = "Controls_Plant_3"
!
variable modify  &
   variable_name = .SCARA_IRCCyN.Controls_Plant_3.solver_type  &
   string_value = "cplusplus"
!
variable modify  &
   variable_name = .SCARA_IRCCyN.Controls_Plant_3.target  &
   string_value = "MATLAB"
!
variable modify  &
   variable_name = .SCARA_IRCCyN.Controls_Plant_3.analysis_type  &
   string_value = "non_linear"
!
variable modify  &
   variable_name = .SCARA_IRCCyN.Controls_Plant_3.analysis_init  &
   string_value = "no"
!
variable modify  &
   variable_name = .SCARA_IRCCyN.Controls_Plant_3.analysis_init_str  &
   string_value = ""
!
variable modify  &
   variable_name = .SCARA_IRCCyN.Controls_Plant_3.user_lib  &
   string_value = ""
!
variable modify  &
   variable_name = .SCARA_IRCCyN.Controls_Plant_3.host  &
   string_value = "pc-d05-07.eleves.ecn"
!
variable modify  &
   variable_name = .SCARA_IRCCyN.Controls_Plant_3.dynamic_state  &
   string_value = "on"
!
variable modify  &
   variable_name = .SCARA_IRCCyN.Controls_Plant_3.tcp_ip  &
   string_value = "off"
!
variable modify  &
   variable_name = .SCARA_IRCCyN.Controls_Plant_3.output_rate  &
   integer_value = 1
!
ude modify instance  &
   instance_name = .SCARA_IRCCyN.Controls_Plant_3
...
!
variable modify  &
   variable_name = .SCARA_IRCCyN.velocity_control.input_channels  &
   object_value =   &
      .SCARA_IRCCyN.q1d,  &
      .SCARA_IRCCyN.q2d
!
variable modify  &
   variable_name = .SCARA_IRCCyN.velocity_control.output_channels  &
   object_value =   &
      .SCARA_IRCCyN.q1,  &
      .SCARA_IRCCyN.q2,  &
      .SCARA_IRCCyN.x,  &
...
!
variable modify  &
   variable_name = .SCARA_IRCCyN.velocity_control.file_name  &
   string_value = "Controls_Plant_3"
!
variable modify  &
   variable_name = .SCARA_IRCCyN.velocity_control.solver_type  &
   string_value = "cplusplus"
!
variable modify  &
   variable_name = .SCARA_IRCCyN.velocity_control.target  &
   string_value = "MATLAB"
!
variable modify  &
   variable_name = .SCARA_IRCCyN.velocity_control.analysis_type  &
   string_value = "non_linear"
!
variable modify  &
   variable_name = .SCARA_IRCCyN.velocity_control.analysis_init  &
   string_value = "no"
!
variable modify  &
   variable_name = .SCARA_IRCCyN.velocity_control.analysis_init_str  &
   string_value = ""
!
variable modify  &
   variable_name = .SCARA_IRCCyN.velocity_control.user_lib  &
   string_value = ""
!
variable modify  &
   variable_name = .SCARA_IRCCyN.velocity_control.host  &
   string_value = "pc-d05-07.eleves.ecn"
!
variable modify  &
   variable_name = .SCARA_IRCCyN.velocity_control.dynamic_state  &
   string_value = "on"
!
variable modify  &
   variable_name = .SCARA_IRCCyN.velocity_control.tcp_ip  &
   string_value = "off"
!
variable modify  &
   variable_name = .SCARA_IRCCyN.velocity_control.output_rate  &
   integer_value = 1
!
ude modify instance  &
   instance_name = .SCARA_IRCCyN.velocity_control

...
ADAMS_exec = '' ;
ADAMS_host = 'pc-d05-07.eleves.ecn' ;
ADAMS_cwd ='\\data-pfe\gkregulan2017\.Bureau\Lab4_ADAMS'  ;
ADAMS_prefix = 'Controls_Plant_3' ;
ADAMS_static = 'no' ;
ADAMS_solver_type = 'C++' ;
...
ADAMS_init = '' ;
ADAMS_inputs  = 'q1d!q2d' ;
ADAMS_outputs = 'q1!q2!x!y' ;
ADAMS_pinput = 'velocity_control.ctrl_pinput' ;
ADAMS_poutput = 'velocity_control.ctrl_poutput' ;
ADAMS_uy_ids  = [
                   6
                   7
                   1
